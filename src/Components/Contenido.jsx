...
const Contenido = () => {
  return (
      <>
        ...
        <h1 style={{fontSize:'32px', font: 'bold'}}>Misión: Una transformación rural duradera</h1>
        <p>La principal misión del IFAD es transformar las economías rurales y sus sistemas alimentarios con intención de hacerlos más inclusivos, productivos, resistentes y sostenibles [7]. Se busca invertir en las personas que corren más riesgo de quedarse rezagados: los pobres, los pequeños productores de alimentos, las mujeres, los jóvenes y otros grupos vulnerables que viven en las zonas rurales. 
        ...
        <h1 style={{fontSize:'32px', font: 'bold'}}>Estrategia: Fomentar el desarrollo rural sostenible</h1>
        <p>
        ...
        <h1 style={{fontSize:'32px', font: 'bold'}}>Capacitando a las personas para que dirijan su propio desarrollo </h1>
        <p>
        ...
        <ol>
                <li>
                    <b>Respondiendo a la COVID-19:</b> El brote de COVID-19 se ha extendido rápidamente por todo el mundo, perturbando profundamente las actividades fundamentales que unen a la comunidad mundial, incluida la agricultura, y poniendo en peligro a todos los que dependen de ella. [19]</li>
                <li>
                    <b>Clima y medio ambiente:</b> Los pequeños agricultores y la población rural pobre se llevan la peor parte del cambio climático y la degradación de los recursos naturales. Los fenómenos meteorológicos extremos, como lo son las sequías, las tormentas y las inundaciones, están ejerciendo presión sobre los ecosistemas de los que dependen de la agricultura. [20]</li>
                <li>
                    <b>Cultivos:</b> Los pequeños agricultores son los principales productores de alimentos a nivel mundial, según datos del IFAD, proporcionan entre el 60% y el 80% de los alimentos producidos en los países en desarrollo. A medida que la población mundial crece, estos agricultores se ven sometidos a una presión cada vez mayor para mejorar su productividad. [21]</li>
                <li>
                    <b>Pesca y acuicultura:</b> La pesca y la acuicultura son el sustento de casi 500 millones de personas en el mundo, sin embargo, muchas de estas pesquerías se encuentran en grave riesgo por culpa de la presión humana, como lo es la sobreexplotación, la contaminación y los cambios en los hábitats. [22]</li>
                <li>
                    <b>Género:</b> las mujeres contribuyen en gran medida a la agricultura y a las economías rurales, pero se enfrentan a numerosos retos que los hombres no sufren; las mujeres tienen menos acceso a los recursos y a servicios como la propiedad, la financiación, la formación, los insumos y el equipamiento. [23]</li>
                <li>
                    <b>Pueblos Indígenas:</b> Se calcula que hay más de 476 millones de personas que se identifican como indígenas en unos 90 países del mundo, pero, con demasiada frecuencia, siguen siendo víctimas de discriminaciones y sus voces siguen sin ser escuchadas. [24]</li>
                <li>
                    <b>Instituciones y organizaciones:</b> La población rural pobre rara vez controla las condiciones que determinan sus medios de vida, dispersos geográficamente en áreas remotas, los pequeños productores carecen de las infraestructuras básicas (bancos, carreteras, suministro eléctrico, conexión a internet, etcétera) necesarias para manejar sus negocios. [25]</li>
                <li>
                    <b>Terrenos:</b> La competencia por las tierras nunca ha sido mayor; el mundo se enfrenta al aumento de la población, la rápida urbanización, el cambio climático, la disminución de la fertilidad del suelo y la creciente demanda de seguridad alimentaria y de combustibles. Todo esto ejerce presión sobre la tierra. [26]</li>
                <li>
                    <b>Ganados y pastizales:</b> El ganado contribuye a las operaciones agrícolas de más de 800 millones de pequeños productores pobres; los hogares rurales pueden mejorar sus medios de vida criando una gran variedad de animales. [27]</li>
            </ol>
            <p>IFAD actúa en forma para garantizar que nadie se quede atrás, centrándose en áreas como el género, la juventud y la nutrición; invirtiendo para garantizar la sostenibilidad, la resiliencia climática y el progreso económico inclusivo. Ayuda a las personas y a sus comunidades a alcanzar sus objetivos y transformar sus comunidades para bien. El IFAD busca terminar con la pobreza rural para 2030.</p>
        </>
  )
}
